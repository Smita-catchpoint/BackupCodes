...
namespace CustomSerializer
{
    ...
    class CustomSerialization4
    {
        static void Main()
        {
            ...
            {
                Converters = new List<JsonConverter> { new MyTestClassConverter() },
...
//            var myTestClass = new MyTestClass
//            {
//                Person = new Person5 { Name = "John Doe", Age = 30, City = "New York" },
...
//            var json = JsonConvert.SerializeObject(myTestClass, settings);
